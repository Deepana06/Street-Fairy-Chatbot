...
query = r"""
SELECT  business_id,name,latitude,longitude,categories,attributes,state, city ,POSTAL_CODE,stars, hours
...
df["combined_info"] = (
    ...
    df["HOURS"].fillna("") + ". " +
    "Rated:" + df["STARS"].astype(str) + " stars."+ # state, city, Postalcode
    "State:" +df["STATE"]+"."+
    "City:"+df["CITY"]+"."+
    "Postal_code:"+df["POSTAL_CODE"].astype(str)
)
